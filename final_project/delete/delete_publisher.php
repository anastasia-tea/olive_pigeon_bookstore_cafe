...
if(isset($_POST["submit"])) {
    ...
    $user_data = [$_POST['publisher_id']];

    require_once '../connect.php';
    $sql = "DELETE FROM publisher WHERE publisher_id LIKE ?";
...
<html>
    ...
    <div class="container p-5"> 
        ...
        <h5>This interface allows staff members to delete a book publisher in the database.</h5> 
        <hr/>
        <br><br>
