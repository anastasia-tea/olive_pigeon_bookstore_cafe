...
if(isset($_POST["submit"])) {
    ...
    $user_data = [$_POST['staff_fname'], $_POST['staff_initial'], $_POST['staff_lname'], $_POST['staff_email'], $_POST['staff_phone'], $_POST['staff_job_title'], $_POST['staff_hourly_wage'], $_POST['store_id'], $_POST['staff_id']];

    require_once '../connect.php';
    $sql = "UPDATE staff SET staff_fname = ?, staff_initial = ?, staff_lname = ?, staff_email = ?, staff_phone = ?, staff_job_title = ?, staff_hourly_wage = ?, fk_store_id = ? WHERE staff_id LIKE ?";
...
<html>
    ...
    <div class="container p-5"> 
        ...
        <h5>This interface allows staff members to update a new staff member account in the database.</h5> 
        <hr/>
        <br><br>
        <form method="POST" action="#">
           ...
           <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input name="staff_hourlywage" type="number" step="0.01" class="form-control">
            </div>
            <div class="mb-3">
