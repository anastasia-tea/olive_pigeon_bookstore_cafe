...
if(isset($_POST["submit"])) {
    ...
    $user_data = [$_POST['bev_name'], $_POST['bev_desc'], $_POST['bev_price'], $_POST['bev_size'], $_POST['bev_id']];

    require_once '../connect.php';
    $sql = "UPDATE beverage SET beverage_name = ?, beverage_desc = ?, beverage_price = ?, beverage_size = ? WHERE beverage_id LIKE ?";
...
<html>
    ...
    <div class="container p-5"> 
        ...
        <h5>This interface allows staff members to update a beverage in the database.</h5> 
        <hr/>
        <br><br>
