...
if(isset($_POST["submit"])) {
    ...
    $user_data = [$_POST['order_detail_id'], $_POST['beverage_id'], $_POST['milk_id'], $_POST['syrup_id'], $_POST['quantity'], $_POST['beverage_detail_id']];

    require_once '../connect.php';
    $sql = "UPDATE beverage_detail SET fk_order_detail_id = ?, fk_beverage_id = ?, fk_milk_id = ?, fk_syrup_id = ?, quantity = ? WHERE beverage_detail_id LIKE ?";
...
<html>
    <head>
        <title>Update Beverage Details</title>
         <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-sRIl4kxILFvY47J16cr9ZwB07vP4J8+LH7qKQnuqkuIAvNWLzeN8tE5YBujZqJLB" crossorigin="anonymous">
    </head>

    <body>
    <div class="container p-5"> 
        <h1>Update Beverage Details</h1> 
        <h5>This interface allows staff members to update order details of beverages in the database.</h5> 
        <hr/>
        <br><br>
