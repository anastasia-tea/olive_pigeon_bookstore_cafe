...
if(isset($_POST["submit"])) {
    ...
    $user_data = [$_POST['order_date'], $_POST['total_price'], $_POST['store_id'], $_POST['staff_id'], $_POST['customer_id'], $_POST['order_id']];

    require_once '../connect.php';
    $sql = "UPDATE orders SET order_date = ?, order_total_price = ?, fk_store_id = ?, fk_staff_id = ?, fk_customer_id = ? WHERE order_id LIKE ?";
...
<html>
    ...
    <div class="container p-5"> 
        <h1>Update Order</h1> 
        <h5>This interface allows staff members to update a customer order in the database.</h5> 
        <hr/>
        <br><br>
