...
if(isset($_POST["submit"])) {
    ...
    $user_data = [$_POST['order_detail_id'], $_POST['order_id'], $_POST['book_id'], $_POST['pastry_id'], $_POST['beverage_id'], $_POST['quantity_ordered'], $_POST['total_price']];

    require_once '../connect.php';
    $sql = "INSERT INTO order_detail (order_detail_id, fk_order_id, fk_book_id, fk_pastry_id, fk_beverage_id, quantity_ordered, detail_total_price) VALUES (?,?,?,?,?,?,?)";
...
<html>
    ...
    <div class="container p-5"> 
        ...
        <h5>This interface allows staff members to add customer order details to the database.</h5> 
        <hr/>
        <br><br>
        <form method="POST" action="#">
            ...
            <div class="mb-3">
                ...
                <input name="pastry_id" type="text" class="form-control">
            </div>
            <div class="mb-3">
                <label class="form-label">Beverage ID</label>
                <input name="beverage_id" type="text" class="form-control">
            </div>
            <div class="mb-3">
